 ...
 * with object properties representing row data. This ORM generally follows
...
class ORM_Core {
	...
	public function __call($method, array $args)
	{
		if (method_exists($this->db_builder, $method))
		{
			if (in_array($method, array('execute', 'insert', 'update', 'delete')))
				throw new System_Exception('Query methods cannot be used through ORM');
		...
		{
			throw new System_Exception('Invalid method :method called in :class',
	...
	public function __get($column)
	{
		...
		{
			throw new System_Exception('The :property property does not exist in the :class class',
